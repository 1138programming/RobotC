...
#pragma config(Motor,  port7,           collector,     tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port8,           launcher2,     tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port9,           launcher3,     tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port10,          launcher4,     tmotorVex393_HBridge, openLoop)
