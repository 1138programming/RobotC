...
#pragma config(Motor,  port3,           liftLeft1,     tmotorVex393_MC29, openLoop, driveLeft, encoderPort, I2C_4)
...
#pragma config(Motor,  port10,          backRight,     tmotorVex393_HBridge, openLoop, reversed, driveRight, encoderPort, I2C_2)
