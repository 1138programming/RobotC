...
#pragma config(Motor,  port8,           LeftSlider,    tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port9,           RightSlider,   tmotorVex393_MC29, openLoop)
...
task usercontrol()
{
  ...
  while (true)
  {
    ...
    {
    	motor[LeftSlider] = 127 ;
    	motor[RightSlider] = 127 ;
    }
