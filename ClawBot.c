#pragma config(Motor,  port1,           LeftDriveMotor, tmotorVex393_HBridge, openLoop, reversed)
...
#pragma config(Motor,  port10,          RightDriveMotor, tmotorVex269_HBridge, openLoop)
	...
	while (true)
{
		...
		{
			motor[ClawMotor] = 0 ; //Claw stays where it is
		}
